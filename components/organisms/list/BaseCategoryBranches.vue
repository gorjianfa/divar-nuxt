  ...
  <div>
    ...
    >
      <div class="tw-flex tw-flex-col tw-gap-3 tw-w-full">
        ...
        <div class="">
          <ListBaseCategory v-for="(item, i) in list2" :key="i" v-bind="item" />
        </div>
...
export default {
  setup() {
    ...
    const filterList = () => {
      return list2.filter((item) => item.parent !== 'real-estate')
    }
  },
  ...
  computed: {
    ...
    filterItems() {
      return this.list2.filter((item) => item.key !== 'real-estate')
    },
  },
}
</script>
