<template>
  <div>
    <div class="tw-my-8 tw-flex tw-flex-col tw-gap-6 tw-justify-center">
      ...
      <AppInput
        title="کد ملی "
        description="لطفا کد ملی خود را وارد کنید"
        placeholder="nanan"
      >
        <template #append><PriceUnit title="تومان" /></template>
      </AppInput>
        ...
        <template #closesvg>
          <div class="tw-flex">
            <svg
              ...
              aria-hidden="true"
              focusable="false"
              class="tw-max-w-6 tw-max-h-6 tw-w-full tw-h-full tw-fill-gray-600"
            >
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
      ...
      <div class="">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          class="tw-max-w-6 tw-max-h-6 tw-w-full"
        >
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
